...
const core_1 = __importDefault(__nccwpck_require__(386));
const twitter_api_v2_1 = __nccwpck_require__(6845);
const credentials_1 = __nccwpck_require__(4860);
core_1.default.setSecret("consumer_key");
core_1.default.setSecret("consumer_secret");
core_1.default.setSecret("access_token");
core_1.default.setSecret("access_token_secret");
const tweetItem = (tweet, slug) => {
    const newTweet = `New post: ${core_1.default.getInput("hostname")}/${slug}`;
...
getTweetData();
//# sourceMappingURL=data:application/json;base64,
